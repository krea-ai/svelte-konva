/**
     ...
     */
import { Shape as KonvaShape, type ShapeConfig } from 'konva/lib/Shape';
 ...
 * ### Usage:
 * ```tsx
 * <Shape x={100} y={100} width={100} height={50} fill="blue" sceneFunc={() => {}} />
 * ```
 *
 * ### Static config:
 ...
 */
declare const Shape: import("svelte").Component<Props<ShapeConfig>, {
    handle: KonvaShape<{
        ...
        sceneFunc?: ((con: import("konva/lib/Context").Context, shape: KonvaShape) => void) | undefined;
        hitFunc?: ((con: import("konva/lib/Context").Context, shape: KonvaShape) => void) | undefined;
